...
def build_test(cloud='aws',
    ...
    if scenario is not None:
        ...
        env[
            'CLUSTER_NAME'
        ] = f"e2e-{name_hash[:10]}-{name_hash[12:17]}.test-cncf-aws.k8s.io"
    ...
    job = tmpl.render(
        ...
        job_timeout=f'{str(test_timeout_minutes + 30)}m',
        test_timeout=f'{str(test_timeout_minutes)}m',
        marker=marker,
...
def presubmit_test(branch='master',
    ...
    if scenario is not None:
        ...
        env[
            'CLUSTER_NAME'
        ] = f"e2e-{name_hash[:10]}-{name_hash[11:16]}.test-cncf-aws.k8s.io"
        env['KOPS_STATE_STORE'] = 's3://k8s-kops-prow'
        if extra_flags:
            env['KOPS_EXTRA_FLAGS'] = " ".join(extra_flags)
        if irsa and cloud == "aws":
            ...
            for k8s_version in k8s_versions:
                results.extend(
                    build_test(
                        ...
                        ],  # Workaround for test-infra#24747 # pylint: disable=line-too-long
                    )
                    for kops_version in [None]
                )
...
def generate_misc():
    return [
        ...
        build_test(
            name_override="kops-scenario-gcr-mirror",
            runs_per_day=24,
            cloud="aws",
        ...
        build_test(
            name_override="kops-artifacts-sandbox",
            runs_per_day=24,
            cloud="aws",
            k8s_version='stable',
            extra_dashboards=['kops-misc'],
        ...
        build_test(
            name_override="kops-scenario-arm64",
            cloud="aws",
            distro="u2204arm64",
            runs_per_day=1,
            extra_flags=[
        ...
        build_test(
            name_override="kops-aws-cni-calico-deb11",
            cloud="aws",
            distro="deb11",
            networking="calico",
            runs_per_day=3,
        ...
        build_test(
            name_override="kops-aws-cni-calico-flatcar",
            cloud="aws",
            distro="flatcararm64",
            networking="calico",
            runs_per_day=3,
        ...
        build_test(
            name_override="kops-aws-cni-calico-ipv6",
            cloud="aws",
            distro="u2204arm64",
            networking="calico",
            runs_per_day=3,
        ...
        build_test(
            name_override="kops-aws-cni-cilium-ipv6",
            cloud="aws",
            distro="u2204arm64",
            networking="cilium",
            runs_per_day=3,
        ...
        build_test(
            name_override="kops-aws-ipv6-flatcar",
            cloud="aws",
            distro="flatcararm64",
            runs_per_day=3,
            extra_flags=[
        ...
        build_test(
            name_override="kops-aws-cni-calico-ipv6-flatcar",
            cloud="aws",
            distro="flatcararm64",
            networking="calico",
            runs_per_day=3,
        ...
        build_test(
            name_override="kops-scenario-no-irsa",
            cloud="aws",
            distro="u2204arm64",
            runs_per_day=3,
            irsa=False,
        ...
        build_test(
            name_override="kops-aws-private",
            cloud="aws",
            distro="u2204arm64",
            runs_per_day=3,
            networking="calico",
        ...
        build_test(
            name_override="kops-scenario-terraform",
            distro="u2204arm64",
            runs_per_day=1,
        ...
        build_test(
            name_override="kops-scenario-ipv6-terraform",
            distro="u2204arm64",
            runs_per_day=1,
            terraform_version="1.0.5",
            extra_flags=[
        ...
        build_test(
            name_override="kops-aws-ha-euwest1",
            distro="u2204arm64",
            networking="calico",
            kops_channel="alpha",
            runs_per_day=3,
        ...
        build_test(
            name_override="kops-aws-arm64-release",
            k8s_version="latest",
            distro="u2204arm64",
            networking="calico",
            kops_channel="alpha",
        ...
        build_test(
            name_override="kops-aws-arm64-ci",
            k8s_version="ci",
            distro="u2204arm64",
            networking="calico",
            kops_channel="alpha",
        ...
        build_test(
            name_override="kops-aws-arm64-conformance",
            k8s_version="ci",
            distro="u2204arm64",
            networking="calico",
            kops_channel="alpha",
        ...
        build_test(
            name_override="kops-aws-amd64-conformance",
            k8s_version="ci",
            distro='u2204',
            networking="calico",
            kops_channel="alpha",
            runs_per_day=3,
            extra_flags=["--node-size=c5.large", "--master-size=c5.large"],
            skip_regex=r'\[Slow\]|\[Serial\]|\[Flaky\]',
            focus_regex=r'\[Conformance\]|\[NodeConformance\]',
            extra_dashboards=["kops-misc"],
        ),
        build_test(
            name_override="kops-aws-updown",
            k8s_version="stable",
            distro="u2204arm64",
            networking="calico",
            kops_channel="alpha",
        ...
        build_test(
            name_override="kops-aws-aws-load-balancer-controller",
            cloud="aws",
            networking="cilium",
            kops_channel="alpha",
            k8s_version="stable",
        ...
        build_test(
            name_override="kops-aws-keypair-rotation-ha",
            cloud="aws",
            kops_channel="alpha",
            k8s_version="stable",
            runs_per_day=1,
        ...
        build_test(
            name_override="kops-aws-metrics-server",
            cloud="aws",
            networking="cilium",
            kops_channel="alpha",
            k8s_version="stable",
        ...
        build_test(
            name_override="kops-aws-pod-identity-webhook",
            cloud="aws",
            networking="cilium",
            kops_channel="alpha",
            k8s_version="stable",
        ...
        build_test(
            name_override="kops-aws-addon-resource-tracking",
            cloud="aws",
            networking="cilium",
            kops_channel="alpha",
            k8s_version="stable",
        ...
        build_test(
            name_override="kops-aws-external-dns",
            cloud="aws",
            distro="u2204arm64",
            networking="cilium",
            kops_channel="alpha",
        ...
        build_test(
            name_override="kops-aws-apiserver-nodes",
            cloud="aws",
            distro="u2204arm64",
            runs_per_day=3,
        ...
        build_test(
            name_override="kops-aws-karpenter",
            distro="u2204arm64",
            networking="cilium",
            kops_channel="alpha",
            runs_per_day=1,
        ...
        build_test(
            name_override="kops-aws-ipv6-karpenter",
            distro="u2204arm64",
            networking="cilium",
            kops_channel="alpha",
            runs_per_day=1,
        ...
        build_test(
            name_override="kops-aws-selinux",
...
def generate_upgrades():
    ...
    for versions in versions_list:
        ...
        results.append(
            build_test(
                name_override=f"{job_name}-many-addons",
                distro='u2004',
                networking='calico',
                irsa=k8s_a >= 'v1.22',
                k8s_version='stable',
